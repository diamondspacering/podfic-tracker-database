...
import { useEventPodfics, useScheduleEvents } from '@/app/lib/swrLoaders';
import EventContent from '@/app/lib/EventContentOld';
...
// TODO: this should just be an old schedule page I want one that's automatic and I don't drag things into rn
export default function SchedulePage() {
  ...
  const { scheduleEvents: scheduledEvents, isLoading: scheduledEventsLoading } =
    useScheduleEvents({});
