...
export async function GET(request: NextRequest) {
  ...
  let queryString = `
   select schedule_event_id,schedule_event.podfic_id,schedule_event.section_id,schedule_event.part_id,schedule_event.round_id,
       ...
       section.number as section_number, section.wordcount as section_wordcount, section.title as section_title, section.status as section_status, section.podfic_id,
